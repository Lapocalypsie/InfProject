...
const CommentaryBox = ({ id }) => {
    ...
    const handleClick = () => {
        ...
        sessionStorage.setItem(id, JSON.stringify([...currentComments, newComment]));
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        <Button
                            ...
                            className={`px-6 py-3 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed ${isSubmitting ? 'opacity-75 cursor-wait' : ''}`}
                            icon={null}
